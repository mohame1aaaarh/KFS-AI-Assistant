...
GRADE_SCALE = [
    (96, 100, 4.0, "A+", "ممتاز مرتفع", "High Excellent"),
    (92, 95,  3.7, "A",  "ممتاز", "Excellent"),
    (88, 91,  3.4, "A-", "ممتاز منخفض", "Low Excellent"),
    (84, 87,  3.2, "B+", "جيد جدا مرتفع", "High Very Good"),
    (80, 83,  3.0, "B",  "جيد جدا", "Very Good"),
    (76, 79,  2.8, "B-", "جيد جدا منخفض", "Low Very Good"),
    (72, 75,  2.6, "C+", "جيد مرتفع", "High Good"),
    (68, 71,  2.4, "C",  "جيد", "Good"),
    (64, 67,  2.2, "C-", "جيد منخفض", "Low Good"),
    (60, 63,  2.0, "D+", "مقبول مرتفع", "High Pass"),
    (55, 59,  1.5, "D",  "مقبول", "Pass"),
    (50, 54,  1.0, "D-", "مقبول منخفض", "Low Pass"),
