...
**مساعد ذكي + حاسبة GPA لطلاب كلية الذكاء الاصطناعي — جامعة كفر الشيخ**

> 🧠 **مساعد RAG:** يجيب عن أسئلة الطلاب حول اللائحة الداخلية — المواد التنظيمية، الخطط الدراسية، توصيف المقررات، نظام الامتحانات، وشروط القبول.
>
> 📊 **حاسبة GPA:** تحسب GPA كل ترم و CGPA التراكمي بناءً على درجات الطالب وجدول النقاط المعتمد من المادة (15) من اللائحة.
...
اللائحة الداخلية وثيقة كبيرة (أكثر من 40 صفحة) يصعب على الطالب الجديد تصفحها والبحث فيها. هذا المشروع يقدم **أداتين**:
...
### 📊 حاسبة GPA
- ✅ حساب GPA لكل فصل دراسي على حدة
- ✅ حساب CGPA التراكمي عبر كل الترمات
- ✅ تحويل النسبة المئوية إلى نقاط (4.0 scale) حسب المادة (15)
- ✅ عرض التقدير العام (ممتاز، جيد جداً، جيد، مقبول، إلخ)
- ✅ دعم قواعد إعادة المقرر (الحد الأقصى 83%)
- ✅ كشف أهلية مرتبة الشرف (CGPA ≥ 3.0)
...
│   ├── rag_engine.py                  ← قلب نظام RAG: تضمين → بحث → توليد
│   ├── prompts.py                     ← نصوص system prompts (عربي/إنجليزي)
│   ├── courses_data.py                ← بيانات المقررات + جدول الدرجات + دوال GPA
...
- [x] **حاسبة GPA** (قيد التطوير — راجع `GPA-FEATURE-PLAN.md`)
